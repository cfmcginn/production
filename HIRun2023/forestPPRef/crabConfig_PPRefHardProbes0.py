...
config.General.requestName = "forest_miniAOD_run3_ppref_Data_PPRefHardProbes0"
...
config.Data.outputDatasetTag = "forest_miniAOD_run3_ppref_Data_PPRefHardProbes0"
